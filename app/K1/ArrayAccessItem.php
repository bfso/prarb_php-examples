...
class ArrayAccessItem {
    public static function getFirstItem(array $items) {
        // Complete this function to return the first item of an given array
        // use the keyword "return" to give back the value
        return $items[0];
    }
    ...
    public static function getLastItem(array $items){
        // Complete this function to return the last
        // item of an one-dimensional array.
